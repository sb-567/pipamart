...
$composerAutoload = dirname(dirname(dirname(dirname(__DIR__)))) . '/autoload.php';
if (!file_exists($composerAutoload)) {
    //If the project is used as its own project, it would use rest-api-sdk-php composer autoloader.
    $composerAutoload = dirname(dirname(dirname(dirname(__DIR__)))) . '/vendor/autoload.php';
...
$clientId = 'AcHrwP4VHD8x4EOB1UlIcof3bMB0oYYYjHfwO8STmh4JtncocJ3HK03lqy3YXYVGC3i6P-XdyqXQ-Aq2';
$clientSecret = 'EJwVTBGDKymCNfoKi5PEmOyo-Ipdrl18K3RpetS1UB_hTyYNSZ92a3ysB8Sjo2Dpie7yfesGl3GB8VJW';
