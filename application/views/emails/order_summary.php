                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <td width="100%" align="center"><table width="280" class="m_-3575512029768076440tableCol" cellpadding="0" cellspacing="0" border="0" align="left">
                                                      <tbody>
                                                        <tr>
                                                          <td align="center" style="padding:20px 10px"><div style="width:240px"> <img src="<?=$value['product_img']?>" width="100%" style="border:none"> </div></td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td align="center" style="font:13.2px/165% Arial;color:#000000;padding:15px 10px;font-weight: 600">
                                                            <a href="<?=$value['product_url']?>" target="_blank"><?=$value['product_title']?></a>
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td bgcolor="#ffffff" style="padding:5px 10px"><table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                                                              <tbody>
                                                                <tr>
                                                                  <td><table width="100%" cellpadding="0" cellspacing="0" border="0" align="" style="margin-top:15px">
                                                                      <tbody>
                                                                        <tr>
                                                                          <td align="" style="font:12px/150% Arial;color:#909090"><span style="font-weight:bold"> <?=$this->lang->line('estimated_delivery_lbl')?>:</span><br>
                                                                            <span style="font-size:13px"> <?=$value['delivery_date']?></span></td>
                                                                        </tr>
                                                                      </tbody>
                                                                    </table></td>
                                                                </tr>
                                                        ...
                                                        <tr>
                                                          <td bgcolor="#ffffff" style="padding:10px 10px 0 10px;font:13.5px/150% Arial;color:#909090"><table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                                                              <tbody>
                                                                ...
                                                                <tr>
                                                                  <td width="50%" align="left" style="padding:10px 0;border-bottom:1px solid #ebebeb"><?=$this->lang->line('delivery_charge_lbl')?></td>
