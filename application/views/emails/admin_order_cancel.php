                      ...
                      <tbody>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td align="center" style="font:13.2px/165% Arial;color:#000000;padding:15px 10px;font-weight: 600">
                                                            <a href="<?=$value['product_url']?>" target="_blank"><a href="<?=$value['product_url']?>" target="_blank"><?=$value['product_title']?></a>
                                                          </td>
                                                        </tr>
                                                        <tr>
                        ...
                        <tr>
                          <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;margin-right:auto;margin-left:auto;">
                            <center>
                              <p style="margin:0;text-align:center;margin-right:auto;margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:15px;color:#a1a8ad;line-height:23px;">© <?=$this->db->get_where('tbl_settings', array('id' => '1'))->row()->app_name?></p>
                            </center>
                          </td>
                        </tr>
                        <!-- whitespace -->
