                ...
                <tbody>
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                        ...
                        <p class="description" style="font-family:'Verdana';margin:0;text-align:left;max-width:100%;color:#a1a8ad;line-height:24px;font-size:15px;margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(161, 168, 173); font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">Someone recently sent partner with us data:</span></p>
                        <p class="description" style="font-family:'Verdana';margin:0;text-align:left;max-width:100%;line-height:24px;font-size:15px;margin-bottom:10px;margin-left: auto; margin-right: auto;"><strong>Name:</strong> <?=$contact_name?></p>
                        <p class="description" style="font-family:'Verdana';margin:0;text-align:left;max-width:100%;line-height:24px;font-size:15px;margin-bottom:10px;margin-left: auto; margin-right: auto;"><strong>Phone:</strong> <?=$contact_phone?></p>
                        <p class="description" style="font-family:'Verdana';margin:0;text-align:left;max-width:100%;line-height:24px;font-size:15px;margin-bottom:10px;margin-left: auto; margin-right: auto;"><strong>Enquiry For:</strong> <?=$enquiry_for?></p>
                        <p class="description" style="font-family:'Verdana';margin:0;text-align:left;max-width:100%;line-height:24px;font-size:15px;margin-bottom:5px;margin-left: auto; margin-right: auto;"><strong>Message:</strong> <div><?=$contact_msg?></div></p>
                    </td>
                  </tr>
                </tbody>
              </table>
