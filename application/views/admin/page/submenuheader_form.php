  ...
  <div class="col-md-12">
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($sub_category)){ echo site_url('admin/SubMenu/addForm').'?redirect='.$redirect; }else{  echo site_url('admin/SubMenu/editForm/'.$sub_category[0]->id).'?redirect='.$redirect;} ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
            <div class="section-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input type="text" placeholder="<?=$this->lang->line('title_place_lbl')?>" id="title" name="title" class="form-control" value="<?php if(isset($sub_category)){ echo $sub_category[0]->submenu_header;} ?>">
                </div>
              </div>
              ...
              {
                echo '<input type="hidden" class="header_id" value="'.$sub_category[0]->id.'">';  
              } 
              ?>
                  <?php 
                          if(isset($sub_category))
