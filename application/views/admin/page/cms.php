      ...
      <div class="card-body mrg_bottom" style="padding: 20px">
        ...
        <div class="row">
          <div class="col-md-12 mrg-top manage_comment_btn">
                <div class="add_btn_primary"> <a href="<?=site_url('admin/cms/add/'.$flag)?>" class="btn_edit"><?=$this->lang->line('add_new_lbl')?></a></div>
                <div class="clearfix"></div>
                <br/>
                    ...
                    <?php 
                      ...
                      foreach ($data as $key => $value) {
                        ...
                        <tr class="item_holder">
                          ...
                          <td><?=$value->title?></td>
                          <td nowrap="">
                            <a href="<?=site_url('admin/cms/edit/'.$value->id)?>?redirect=<?=$redirectUrl?>" class="btn btn-primary btn_edit" data-toggle="tooltip" data-tooltip="<?=$this->lang->line('edit_lbl')?>"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
  ...
  $(".btn_delete").click(function(e){
      ...
      e.preventDefault(); 
      var href = '<?php echo base_url(); ?>admin/cms/delete_data/'+_id;
      var btn = this;
