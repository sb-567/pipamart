...
if($product->product_size !=''){
	...
	if($size_chart!=''){
		$size_view.='<div class="sizeadjust">
		            <p style="font-weight: 600">'.$this->lang->line('size_lbl').': </p>
					<div class="radio-group">
					'.$size.'
					<input type="hidden" id="radio-value" name="product_size" value="'.$selected_size.'" />
					</div>
					<a href="" class="size_chart" data-img="'.$size_chart.'">
					<img src="'.base_url('assets/images/size_chart.png').'" style="width:20px;height:20px;margin-right:4px;"> 
					'.$this->lang->line('size_chart_lbl').'
					</a>
					</div>';
	}
}
	...
	<div class="container-fluid"> 
		<div class="row">
			<div class="single-product-info mb-50"> 
			    ...
			    <div class="col-md-5 col-sm-4 text-center tz-gallery"> 
			    <div class="sticky">
					<?php 
						if(!$is_avail)
						{
						...
						<div class="single-product-price" style="margin-bottom: 0px;"> 
							...
							<div class="single-product-quantity">
								...
								if($product->color!=''){
									...
									$color_code=isset($color_arr[1]) ? $color_arr[1] : "FFFFFF";

									echo '<h4><strong>'.$this->lang->line('colour_lbl').':</strong> '.$color_name.'<div class="single-product-color" style="height: 25px;width: 25px;background-color: #'.$color_code.';border-radius: 8px;"></div></h4>';	
									// echo '';
								}
